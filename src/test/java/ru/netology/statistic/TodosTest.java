...
public class TodosTest {
    ...
    Epic epic1 = new Epic(53, subtasks1);
    String[] subtasks2 = {"Кефир", "Огурцы", "Курица"};
    Epic epic2 = new Epic(53, subtasks2);
    String[] subtasks3 = {"Помидоры", "Сметана", "Торт"};
    Epic epic3 = new Epic(53, subtasks3);
